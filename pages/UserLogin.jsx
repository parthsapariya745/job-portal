    ...
    <div className="w-full">
      ...
      <section className="bg-primary text-white py-8 md:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-blue-100">Access your account to manage jobs and applications</p>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16">
        <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white p-8 rounded-lg shadow-sm border border-neutral-200">
            {/* User Type Selection */}
            <div className="mb-6">
              <label className="block text-sm font-medium text-neutral-700 mb-3">Login as:</label>
